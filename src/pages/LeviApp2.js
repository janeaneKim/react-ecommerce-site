  ...
  return (
    <><>
          ...
          <section className='section'>
              ...
              <img  src="https://omnipemf.com/wp-content/uploads/2021/06/improve-meditation-practice.png" className="col-md-6 float-md-end mb-3 ms-md-3" alt="" />
              <br>
              </br>
              <img className="One" src="https://omnipemf.com/wp-content/uploads/2021/06/Ikone-07.svg" alt="Cognition" />
              <h5 className="Stylee">IMPROVED COGNITIVE FUNCTION</h5>
              <p>
              NeoRhythm helps with improving cognitive performance, attention and reducing the proportion of errors.
              </p>
              <img className="Two" src="https://omnipemf.com/wp-content/uploads/2021/06/Ikone-08.svg" alt="Heart Rate" />
              ...
              <h5 className="Stylee">{Energy}</h5>
              <p>
                  NeoRhytm introduces magnetic energy into your body to boost and revitalize energy levels.
              </p>
              <img className="Six" src="https://omnipemf.com/wp-content/uploads/2021/06/MeditationPratcie_03.svg" alt="Heightened Focus" />
              <h5 className="Stylee">EMOTIONAL WELLBEING</h5>
              <p>
              ...
              <button type="button btn btn-primary">Buy Now For $49.99</button>
              <img className= "Seventy" src={Gif} alt="NeoWrap"/>
          </div></>
