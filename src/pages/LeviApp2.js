    ...
    <>
      <>
        ...
        <section className="section">
          ...
          <p>
            Made out of a soft, skin friendly and breathable fabric. One size
            fits all. Easy to wrap around and affix – make sure the wrap is
            fastened loosely enough for you not to feel any discomfort. Keeps
            your NeoRhythm in place while you are on the go so you can move
            around with ease. Can also be used overnight.
          </p>
          <Outlet />
        </section>
      </>
      <div class="clearfix">
        <img
          src="https://omnipemf.com/wp-content/uploads/2021/06/improve-meditation-practice.png"
        ...
        <img
          class="One"
          src="https://omnipemf.com/wp-content/uploads/2021/06/Ikone-07.svg"
          alt="Cognition"
        />
        <h5 class="Stylee">IMPROVED COGNITIVE FUNCTION</h5>
        <p>
          NeoRhythm helps with improving cognitive performance, attention and
          reducing the proportion of errors.
        </p>
        <img
          class="Two"
          src="https://omnipemf.com/wp-content/uploads/2021/06/Ikone-08.svg"
          alt="Heart Rate"
        />
        ...
        <p>
          NeoRhythm assists your body’s natural recovery process to help you
        ...
        <img
          class="Six"
          src="https://omnipemf.com/wp-content/uploads/2021/06/MeditationPratcie_03.svg"
          alt="Heightened Focus"
        />
        <h5 class="Stylee">EMOTIONAL WELLBEING</h5>
        <p>
          NeoRhythm imitates the brain’s natural rhythms at rest and trains your
          brain to follow those rhythms. When you can calm your brain and body,
          you can calm your life and reach emotional balance and well-being.
        </p>
